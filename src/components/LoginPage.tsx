...
import { MessageSquare, Moon, Sun, Shield, User } from 'lucide-react';
          ...
          <div className="bg-card border rounded-xl p-4 mb-6">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              >
                ...
                <span className="text-sm font-medium">User Demo</span>
              </Button>
              <Button
                variant="outline"
                className="h-auto py-3 flex flex-col items-center gap-1"
                ...
                <div className="grid grid-cols-2 gap-2 mt-1">
                  <button
                    ...
                    className={`py-2 px-3 rounded-lg border text-sm font-medium transition-colors ${
                      role === 'user' ? 'bg-primary text-primary-foreground border-primary' : 'bg-secondary text-secondary-foreground border-border'
                    }`}
                  >
                    <User className="h-4 w-4 inline mr-1" /> User
                  </button>
                  <button
                    type="button"
                    onClick={() => setRole('admin')}
                    className={`py-2 px-3 rounded-lg border text-sm font-medium transition-colors ${
                      role === 'admin' ? 'bg-primary text-primary-foreground border-primary' : 'bg-secondary text-secondary-foreground border-border'
                    }`}
                  >
